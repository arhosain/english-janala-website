...
const removeActive = () => {
  const lessonBtn = document.querySelectorAll('.lesson-active');
...
const displayLesson = (lessons) => {
  ...
  for (let lesson of lessons) {
    ...
    btnDiv.innerHTML = `
    <button id="lesson-btn-${lesson.level_no}" onclick="loadLevelWord(${lesson.level_no})"  class="btn btn-primary btn-outline lesson-active"><i class="fa-solid fa-book-open"></i>
